...
class Text_button(object):
    ...
    def custom(self, x1, y1, t = 'abc', col1 = '#C62002', col2 = '#0BA00C'):
        self.x = x1
        self.y = y1
        self.color1 = col1
        self.color2 = col2
    ...
    def debug(self):
        ...
        noFill()
        stroke(0)
        rect(self.tx1, self.ty1, self.tx2, self.ty2)
        
class Image_button(object):
    def __init__(self):
        self.image1 = loadImage('icon.png')
        self.image2 = loadImage('icon.png')
        self.x = 0
        self.y = 0
        self.w = 0
        self.h = 0
    ...
    def custom(self, x1, y1, w1, h1, img1, img2):
        self.x = x1
        self.y = y1
        self.w = w1
        self.h = h1
